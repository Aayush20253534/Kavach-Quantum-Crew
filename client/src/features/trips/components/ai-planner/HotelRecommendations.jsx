  ...
  return (
    <div className="space-y-5">
      {hotels.map((hotel, idx) => {
        ...
        return (
          <div key={idx} className="group flex flex-col bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-all">
            ...
            <div className="p-4 flex flex-col flex-1">
              <h4 className="text-base font-black text-slate-900 mb-1 leading-tight line-clamp-1">{hotel.name}</h4>
              {hotel.hotel_class && (
                <p className="text-xs font-semibold text-slate-500 mb-4">{hotel.hotel_class} Hotel</p>
              )}
              ...
              <div className="mt-auto flex items-end justify-between pt-4 border-t border-slate-100">
                <div>
                  ...
                  <p className="text-lg font-black text-slate-900 leading-none">{formatPrice(hotel.price)}</p>
                </div>
