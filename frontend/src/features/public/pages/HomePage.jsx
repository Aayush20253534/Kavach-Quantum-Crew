...
export function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans selection:bg-white/20">
      ...
      ========================================================= */}
      <section className="relative w-full h-screen min-h-[800px] flex items-center pt-20 overflow-hidden bg-[#050505]">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 max-w-2xl text-left">
            ...
            {/* Main Headline */}
            <h1 className="text-[56px] sm:text-[72px] lg:text-[84px] leading-[1.05] tracking-[-0.03em] font-black text-white mb-6">
            ...
            {/* Description */}
            <p className={`text-[16px] sm:text-[18px] leading-relaxed text-white/70 max-w-lg mb-10 font-medium transition-all duration-1000 delay-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            <div className={`flex flex-wrap items-center gap-5 transition-all duration-1000 delay-1200 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
              ...
              <Link to="/tourist/dashboard" className="group flex items-center gap-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-md px-8 py-4 text-[13px] font-bold uppercase tracking-[0.1em] text-white transition-all duration-300 hover:bg-white/10 hover:border-white/30 hover:-translate-y-1 active:scale-95">
      ...
      ========================================================= */}
      <section id="safe-zones" className="bg-[#050505] py-32 border-t border-white/5 relative z-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-[40px] sm:text-[48px] font-black tracking-tight leading-tight">
                Help is always <br className="hidden sm:block" />
                <span className="text-white/40">closer than you think.</span>
              </h2>
            </div>
            <Link to="/tourist/dashboard" className="group inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-[12px] font-bold uppercase tracking-widest transition-colors hover:bg-white/10">
      ...
      {/* =========================================================
          FEATURES BENTO GRID
      ========================================================= */}
      <section id="features" className="bg-[#050505] py-32 border-t border-white/5 relative z-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
      ...
      <section className="relative py-40 border-t border-white/5 bg-[#050505] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center z-10">
          <h2 className="text-[48px] sm:text-[64px] font-black tracking-tight mb-8">
            Ready to explore?
          </h2>
          <p className="text-[18px] text-white/50 font-medium leading-relaxed max-w-2xl mx-auto mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <Link to="/register" className="group relative overflow-hidden rounded-full bg-white px-10 py-5 text-[13px] font-bold uppercase tracking-[0.1em] text-black transition-all hover:scale-105 active:scale-95 flex items-center gap-3">
              <span>Create Safety ID</span>
