...
export function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans selection:bg-white/20">
      ...
      ========================================================= */}
      <section className="relative w-full min-h-[560px] md:min-h-[700px] flex items-center pt-16 sm:pt-20 py-10 md:py-14 overflow-hidden bg-[#050505]">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10">

          {/* Left Hero Content */}
          <div className="flex-1 max-w-2xl text-left">

            {/* Location Badge */}
            <div className={`inline-flex items-center gap-3 px-3 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-[10px] font-bold uppercase tracking-[0.2em] text-white mb-5 sm:mb-6 transition-all duration-1000 delay-300 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            {/* Main Headline */}
            <h1 className="text-[36px] sm:text-[52px] md:text-[64px] lg:text-[74px] leading-[1.05] tracking-[-0.03em] font-black text-white mb-3 sm:mb-4">
            ...
            {/* Description */}
            <p className={`text-[13px] sm:text-[16px] leading-relaxed text-white/70 max-w-lg mb-6 sm:mb-8 font-medium transition-all duration-1000 delay-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            {/* CTAs */}
            <div className={`flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-4 w-full sm:w-auto transition-all duration-1000 delay-1200 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          ...
          <div className={`hidden lg:block w-[390px] transition-all duration-1000 delay-1500 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="rounded-3xl border border-white/10 bg-black/30 backdrop-blur-xl p-6 shadow-[0_20px_60px_rgba(0,0,0,0.5)] overflow-hidden relative group hover:bg-black/40 transition-colors">
              ...
              <h3 className="text-[26px] font-black text-white tracking-tight uppercase mb-2">Triveni Sangam</h3>
              <p className="text-[12px] text-white/60 leading-relaxed font-medium mb-5">
      ...
      ========================================================= */}
      <section id="safe-zones" className="bg-[#050505] py-12 sm:py-16 md:py-20 border-t border-white/5 relative z-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">

          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-7 md:mb-10 gap-5 md:gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="text-[28px] sm:text-[36px] md:text-[42px] font-black tracking-tight leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {safeZones.map((zone, idx) => (
              <div key={idx} className="group rounded-[1.25rem] border border-white/5 bg-[#0a0a0a] p-5 sm:p-6 transition-all duration-300 hover:border-white/15 hover:bg-[#0f0f0f] hover:-translate-y-1">
      ...
      {/* =========================================================
          FEATURES BENTO GRID
      ========================================================= */}
      <section id="features" className="bg-[#050505] py-12 sm:py-16 md:py-20 border-t border-white/5 relative z-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {features.map((feat, idx) => {
              ...
              return (
                <div key={idx} className={`group rounded-[1.5rem] border border-white/5 bg-[#0a0a0a] p-6 sm:p-7 transition-all duration-300 hover:border-white/10 hover:bg-[#0c0c0c] flex flex-col justify-between ${isLarge ? 'md:col-span-2 lg:col-span-2' : ''}`}>
                  <div>
                    <div className="flex h-11 w-11 items-center justify-center rounded-full bg-white/5 border border-white/5 mb-5 group-hover:scale-110 transition-transform duration-500">
      ...
      {/* =========================================================
          FINAL CTA
      ========================================================= */}
      <section className="relative py-14 sm:py-16 md:py-24 border-t border-white/5 bg-[#050505] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center z-10">
          <h2 className="text-[30px] sm:text-[42px] md:text-[52px] font-black tracking-tight mb-4 md:mb-5">
            Ready to explore?
          </h2>
          <p className="text-[13px] sm:text-[16px] text-white/50 font-medium leading-relaxed max-w-2xl mx-auto mb-7 md:mb-8">
