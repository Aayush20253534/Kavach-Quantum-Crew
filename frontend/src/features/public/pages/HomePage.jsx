...
export function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans selection:bg-white/20">
      ...
      ========================================================= */}
      <section className="relative w-full min-h-[500px] md:min-h-[590px] flex items-center pt-20 sm:pt-24 pb-7 sm:pb-9 md:pb-10 overflow-hidden bg-[#050505]">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">

          {/* Left Hero Content */}
          <div className="flex-1 max-w-2xl text-left">

            {/* Location Badge */}
            <div className={`inline-flex items-center gap-3 px-3 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-[10px] font-bold uppercase tracking-[0.2em] text-white mb-4 sm:mb-5 transition-all duration-1000 delay-300 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            {/* Main Headline */}
            <h1 className="text-[36px] sm:text-[52px] md:text-[64px] lg:text-[74px] leading-[1.05] tracking-[-0.03em] font-black text-white mb-2.5 sm:mb-3">
            ...
            {/* Description */}
            <p className={`text-[13px] sm:text-[16px] leading-relaxed text-white/70 max-w-lg mb-5 sm:mb-6 font-medium transition-all duration-1000 delay-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            <div className={`mt-4 sm:mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.12em] text-white/55 transition-all duration-1000 delay-[1350ms] transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-3 opacity-0'}`}>
              ...
              <span className="inline-flex items-center gap-1.5"><Clock className="h-3.5 w-3.5 text-amber-400" /> 24/7 emergency access</span>
            </div>
          </div>
      ...
      ========================================================= */}
      <section id="safe-zones" className="bg-[#050505] py-8 sm:py-10 md:py-12 border-t border-white/5 relative z-20">
