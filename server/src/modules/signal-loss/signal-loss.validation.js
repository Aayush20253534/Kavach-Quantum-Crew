...
export const groupSeparationParamsSchema = z.object({ alertId: z.string().uuid() });
export const groupSeparationResponseBodySchema = z.object({ response: z.enum(["SAFE", "UNSAFE"]) });
