...
export const incidentAssignmentBodySchema=z.object({responderId:uuid.optional()});
export const incidentNoteBodySchema=z.object({note:z.string().trim().min(2).max(1000)});
