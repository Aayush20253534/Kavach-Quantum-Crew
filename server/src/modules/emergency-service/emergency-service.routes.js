...
export const createEmergencyServiceRouter = ({ controller = emergencyServiceController } = {}) => {
  ...
  router.get("/tracking/:dispatchId", authenticate, authorize(ROLES.TOURIST), validate({ params: emergencyDispatchParamsSchema }), asyncHandler(controller.touristTracking));
